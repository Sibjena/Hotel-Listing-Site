...
module.exports.createListing = async (req, res, next) => {
  try {
    ...
    let response = await geocodingClient
      .forwardGeocode({
        query: req.body.listing.location, // Use the actual location
        limit: 1,
      })
      .send();
    ...
    // } else {
    //   console.error("No features found for the given location.");
...
// res.send("done!")
    ...
    newListing.geometry = response.body.features[0].geometry;  // Add the geometry data
